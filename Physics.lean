...
abbrev OutsourcingBarrier := @InternalitySchema.outsourcing_barrier
...
abbrev ClassificationCascadeNarrows :=
  @NemS.Cosmology.survivor_filter_narrows_class
...
abbrev SemanticTerminality := @NemS.Optimality.TheorySpace.semantic_terminality
...
abbrev ExistentialRigidity := @NemS.Terminality.existential_rigidity
...
abbrev GPTProbabilityClosureForced :=
  @OrderedUnitSpace.closure_implies_state
...
/-- [P42] Record entropy monotone: semantic complexity of stages grows monotonically
    under refinement. -/
abbrev RecordEntropyMonotone :=
  @RecordEntropy.recordEntropy_monotone

/-- [P78] Second-law grounding Track 1: record-resolution monotonicity under closure. -/
abbrev RecordResolutionMonotone :=
  @NemS.Cosmology.Bridges.ucf_record_resolution_monotone

/-- [P78] Second-law grounding Track 2: hidden-history fiber monotonicity. -/
abbrev HiddenHistoryFiberMonotone :=
  @NemS.Cosmology.Bridges.ucf_fiberSize_le_under_forget
...
abbrev SemanticGlueFactorization :=
...
abbrev NoTotalEffectiveLocalSemanticDeterminacy :=
  @CausalNonlocality.no_total_effective_local_semantic_determinacy
...
abbrev ChronologySelectionBarrier :=
...
abbrev BlackHoleInformationPreserved := @BlackHoles.record_consistency_abstract

/-- [P43] Decoder barrier: no universal total-effective decoder exists for the
    decoder-claim predicate. -/
abbrev DecoderBarrier :=
  @ErrorCorrectingClosure.no_total_decider_decoder_claim
...
abbrev SemanticFloor := @NemS.Cosmology.CosmologicalFramework.semantic_floor_theorem
...
abbrev SimulationIsNotRealizationPhysics :=
